      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildPaymentOption(context, 'Pay via M-Pesa', Icons.phone_android, Colors.green, const MpesaPaymentScreen()),
            _buildPaymentOption(context, 'Pay via Credit/Debit Card', Icons.credit_card, Colors.blue, const CardPaymentScreen()),
            _buildPaymentOption(context, 'Pay via Bank Transfer', Icons.account_balance, Colors.orange, const BankPaymentScreen()),
          ],
        ),
      ),
    );
